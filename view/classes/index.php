                    ...
                    ?>
                        <li>
                            <div class="class-summary">
                                <div>
                                    <a class="delete-button" href="<?php echo "index.php?controller=classes&amp;action=enroll&classId=" . $class->getClassId() . "&type=P" ?>">  
                    ...
                    foreach ($monthlyClassesCalendar[$class->getClassId()] as $classDate) {
                        ...
                        ?>
                            <li>
                                <div class="class-summary">
                                    <div>
                                        <a class="delete-button" href="<?php echo "index.php?controller=classes&amp;action=enroll&classId=" . $class->getClassId() . "&type=M" ?>">  
                                            <h3 class="class-summary-title"><?php echo i18n("Class") . $class->getClassId()?></h3>
